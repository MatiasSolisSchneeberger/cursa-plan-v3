...
export default function HeaderCarrera({name, icon}: {name: string; icon: string}) {
	...
	return (
		<header className="w-full flex items-center justify-between p-3 bg-primary-100 dark:bg-primary-900 outline-primary-300 dark:outline-primary-700 outline-2 rounded-3xl">
			{/* boton de volver */}
			...
			{session && (
				<ButtonIcon variant="solid" onClick={handleCarreraFav} color="secondary">
					<IconHeart />
				</ButtonIcon>
			)}
