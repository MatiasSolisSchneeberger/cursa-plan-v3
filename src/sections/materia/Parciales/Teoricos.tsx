			...
			<Card className="col-span-4 md:col-span-6">
				...
				<CardBody>
					<p className="texto-body text-text-700 dark:text-text-300">
						Estos son los parciales teóricos enviado por los usuarios. Si tenes parciales teóricos podes enviarlos para
						que otros usuarios puedan verlos.
					</p>
				</CardBody>
			</Card>
			<Card className="col-span-4 md:col-span-6">
				...
				<CardBody>
					...
					<p className="texto-body text-text-700 dark:text-text-300">
						Los parciales están escrito con en Markdown, si sabés y querés, podés transcribir de las imagenes a Markdown
