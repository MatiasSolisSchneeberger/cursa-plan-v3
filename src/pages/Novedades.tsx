...
const updatesModules = import.meta.glob("./markdown/actualizaciones/*.mdx", {eager: true})
...
export default function Novedad() {
	...
	return (
		<section className="flex flex-col gap-6 py-6 max-w-5xl mx-auto">
						...
						<Card key={index}>
							<CardHeader color="primary">
								<div className="flex flex-col">
									...
									<span className="text-sm font-normal opacity-80">{update.frontmatter.date}</span>
								</div>
							</CardHeader>
