...
export default function ButtonIcon({
	...
	const colorStyles = {
		primary: {
			...
			outlined:
				"text-primary-600 border-1 border-primary-600 dark:text-primary-400 dark:border-primary-400 hover:bg-primary-100 dark:hover:bg-primary-800",
		...
		secondary: {
			...
			outlined:
				"text-secondary-600 border-1 border-secondary-600 dark:text-secondary-400 dark:border-secondary-400 hover:bg-secondary-100 dark:hover:bg-secondary-800",
		...
		tertiary: {
			...
			outlined:
				"text-tertiary-600 border-1 border-tertiary-600 dark:text-tertiary-400 dark:border-tertiary-400 hover:bg-tertiary-100 dark:hover:bg-tertiary-800",
		...
		success: {
			...
			outlined:
				"text-success-600 border-1 border-success-600 dark:text-success-400 dark:border-success-400 hover:bg-success-100 dark:hover:bg-success-800",
		...
		danger: {
			...
			outlined:
				"text-danger-600 border-1 border-danger-600 dark:text-danger-400 dark:border-danger-400 hover:bg-danger-100 dark:hover:bg-danger-800",
		...
		warning: {
			...
			outlined:
				"text-warning-600 border-1 border-warning-600 dark:text-warning-400 dark:border-warning-400 hover:bg-warning-100 dark:hover:bg-warning-800",
		...
		info: {
			...
			outlined:
				"text-info-600 border-1 border-info-600 dark:text-info-400 dark:border-info-400 hover:bg-info-100 dark:hover:bg-info-800",
