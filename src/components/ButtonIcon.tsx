...
export default function ButtonIcon({
	...
	const baseClasses =
		"relative flex flex-row items-center justify-center gap-0 rounded-xl transition-all duration-150 ease-in-out select-none not-disabled:hover:rounded-2xl not-disabled:hover:shadow-md not-disabled:focus:outline not-disabled:focus:outline-offset-2 not-disabled:focus:outline-background-700 not-disabled:active:scale-95 disabled:cursor-not-allowed disabled:opacity-65 dark:not-disabled:focus:outline-background-300"
