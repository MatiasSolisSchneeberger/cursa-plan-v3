...
export default function CalendarDay({
	...
	const colorVariants: Record<CalendarColor, string> = {
		default:
			"text-text-900 dark:text-text-100 hover:bg-background-200 dark:hover:bg-background-800",
	...
	const rangeMiddleVariants: Record<CalendarColor, string> = {
		...
		secondary:
			"bg-secondary-200 text-secondary-600 dark:bg-secondary-900 dark:text-secondary-100",
		tertiary:
			"bg-tertiary-200 text-tertiary-600 dark:bg-tertiary-900 dark:text-tertiary-100",
	...
	return (
		<span
			...
			className={cn(
				...
				isToday &&
					"border-primary-600 dark:border-primary-400 border-4",
				className,
			)}
		>
			{day}
